...
// identical lanes share clk / clk_enable / reset. For BPSK the
// Q lane is constant 0 and can stay tied to 0; the wrapper is
// ready for future I/Q (QPSK/QAM) modulation.
//
// Ports match the single-lane module: filter_in_i / filter_in_q
// are sfix16_En15, 1 sample per clock; filter_out_i / filter_out_q
// are 8 x sfix16_En15 (see anti_imaging_filter_8_par.v for the bus
// mapping and timing conventions).
// -------------------------------------------------------------
module anti_imaging_filter_8_par_iq (
  clk,
  clk_enable,
